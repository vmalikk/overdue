  ...
  return (
    <div className="max-w-4xl space-y-8">
      ...
      <section className="bg-secondary border border-border rounded-lg p-6">
        <h3 className="text-lg font-semibold text-text-primary mb-4">Connection</h3>
      ...
      {config.connected && session && (
        <>
          <section className="bg-secondary border border-border rounded-lg p-6">
            <h3 className="text-lg font-semibold text-text-primary mb-4">Sync Options</h3>
      ...
      {/* Setup Instructions */}
      <section className="bg-secondary border border-border rounded-lg p-6">
        <h3 className="text-lg font-semibold text-text-primary mb-4">Setup Instructions</h3>
        <p className="text-sm text-text-muted">
