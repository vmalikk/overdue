      ...
      <div className="w-full max-w-md">
        <div className="bg-secondary border border-border rounded-lg p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-2 px-4 bg-background hover:bg-accent border border-border text-text-primary font-medium rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
